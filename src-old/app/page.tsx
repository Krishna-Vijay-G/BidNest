...
import { HiOutlineUserGroup, HiOutlineShieldCheck, HiOutlineChartBar, HiOutlineBell, HiOutlineBanknotes, HiOutlineArrowTrendingUp } from 'react-icons/hi2';
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 sm:px-12 py-20 sm:py-32 text-center max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 glass rounded-full px-4 py-1.5 mb-8">
          ...
          <span className="text-foreground-secondary text-sm">Trusted by chit fund managers across India</span>
        </div>
